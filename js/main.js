...
const translations = {
  fr: {
    ...
    'hero.desc': 'Fraîchement diplômé d\'un Master SII à l\'USTHB · Spécialiste IA & NLP · Passionné par les LLMs, le RAG et l\'optimisation algorithmique.',
    'hero.cta1': 'Voir mes projets', 'hero.cta2': 'Me contacter',
    'about.label': '01 — À propos',
    'about.title': 'Ingénieur <em>IA & NLP</em>',
    'about.p1': 'Je suis fraîchement diplômé d\'un Master en Systèmes Informatiques Intelligents à l\'USTHB (Alger), où j\'ai été stagiaire en recherche au <strong>Laboratoire LRIA</strong>. Mon mémoire portait sur un système intelligent de gestion de documents juridiques exploitant les LLMs et la technique RAG.',
    ...
    'projects.p1.badge': 'Terminé · Mémoire PFE',
  ...
  en: {
    ...
    'hero.desc': 'Fresh Master\'s graduate in Intelligent Computer Systems from USTHB · AI & NLP Specialist · Passionate about LLMs, RAG and algorithmic optimization.',
    'hero.cta1': 'View my projects', 'hero.cta2': 'Get in touch',
    'about.label': '01 — About',
    'about.title': 'AI & NLP <em>Engineer</em>',
    'about.p1': 'I am a fresh Master\'s graduate in Intelligent Computer Systems from USTHB (Algiers), where I was a research intern at the <strong>LRIA Laboratory</strong>. My thesis focused on an intelligent legal document management system leveraging LLMs and the RAG technique.',
    ...
    'projects.p1.badge': 'Completed · Master\'s thesis',
